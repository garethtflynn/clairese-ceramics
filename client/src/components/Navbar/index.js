          ...
          <div className="mx-auto max-w-7xl px-2 py-6 sm:px-6 sm:py-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="rounded inline-flex items-center justify-center rounded-md p-2 text-black hover:bg-[#B0BEC7] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
